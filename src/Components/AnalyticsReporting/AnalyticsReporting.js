    ...
    <div className="analytics-dashboard">
      ...
      <nav>
        <ul>
          ...
          <li><Link to="/attendance-leave-reports"><button>Attendance & Leave Reports</button></Link></li>
          <li><Link to="/payroll-tax-reports"><button>Payroll & Tax Reports</button></Link></li>
